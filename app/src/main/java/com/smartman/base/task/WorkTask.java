...
public abstract class WorkTask<Params, Progress, Result> {
    private static final String TAG = WorkTask.class.getSimpleName();
    ...
    private Result doInBackground(Params... params) {
        LogUtil.d(String.format("%s --->doInBackground()", TextUtils.isEmpty(taskId) ? "run " : (taskId + " run ")));
    ...
    final protected void onPreExecute() {
        LogUtil.d(String.format("%s --->onTaskStarted()", TextUtils.isEmpty(taskId) ? "run " : (taskId + " run ")));
        onPrepare();
    }
...
//				resultIsNull();
//			} else {
            LogUtil.d(String.format("%s --->onTaskSuccess()", TextUtils.isEmpty(taskId) ? "run " : (taskId + " run ")));
            onSuccess(result);
//			}
        ...
        LogUtil.d(String.format("%s --->onTaskComplete()", TextUtils.isEmpty(taskId) ? "run " : (taskId + " run ")));
        onFinished();
    }
